...
//ToString 字符串
func (u UUID) ToString(start ...interface{}) string {
	return fmt.Sprint("%s%d", fmt.Sprint(start...), u)
}

//To16 转16进制字符串
func (u UUID) To16(start ...interface{}) string {
	return fmt.Sprintf("%s%x", fmt.Sprint(start...), u)
}

//To36 转36进制字符串
func (u UUID) To36(start ...interface{}) string {
	return fmt.Sprintf("%s%s", fmt.Sprint(start...), intTo36(int64(u)))
}
