...
var registryFlag = cli.StringFlag{
	...
	EnvVar:      "registry",
	//Value:       "lm://.",
	Usage: "" + `注册中心地址。目前支持zookeeper(zk)和本地文件系统(fs)。注册中心用于保存服务启动和运行参数，
...
var nameFlag = cli.StringFlag{
	...
	Usage: "" + `服务全名，指服务在注册中心的完整名称，该名称是以/分隔的多级目录结构，完整的表示该服务所在平台，系统，服务
...
var serverTypesFlag = cli.StringFlag{
	...
	Usage:       fmt.Sprintf("服务类型，目前支持的服务器类型有api,web,rpc,cron,mqc,ws"),
}
