...
func TestNewServer(t *testing.T) {
	tests := []struct {
		...
		{name: "1. NewServer-address-invalid", serverName: "api", addr: "xxxllsd", wantErr: "端口不合法:xxxllsd"},
		{name: "2. NewServer-build-http", serverName: "api", addr: "127.0.0.1:8080", opts: []Option{WithServerType("api"), WithTimeout(30, 30, 30)}},
	}
