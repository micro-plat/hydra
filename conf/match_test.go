...
func TestPathMatch_Match(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:   "t1",
			fields: fields{all: []string{"/test1"}},
			args:   args{service: "/", seq: "/"},
			want:   false,
			want1:  "",
		}, {
			name:   "t2",
			fields: fields{all: []string{"/", "/t1", "/t1/t2", "/t1/t2/t3", "/t1/t2/t3/t4", "/t1/t2/t3/t4/t5"}},
			args:   args{service: "/", seq: "/"},
			want:   true,
			want1:  "/",
		}, {
			name:   "t3",
			fields: fields{all: []string{"/", "/t1", "/t1/t2", "/t1/t2/t3", "/t1/t2/t3/t4", "/t1/t2/t3/t4/t5"}},
			args:   args{service: "/t2/t3", seq: "/"},
			want:   false,
			want1:  "",
		}, {
			name:   "t4",
			fields: fields{all: []string{"/", "/t1", "/t1/t2", "/t1/t2/t3", "/t1/t2/t3/t4", "/t1/t2/t3/t4/t5"}},
			args:   args{service: "/t1/t2/t3", seq: "/"},
			want:   true,
			want1:  "/t1/t2/t3",
		}, {
			name:   "t5",
			fields: fields{all: []string{"/t1/*"}},
			args:   args{service: "/t1/t2", seq: "/"},
			want:   true,
			want1:  "/t1/*",
		}, {
			name:   "t6",
			fields: fields{all: []string{"/t1/*"}},
			args:   args{service: "/t1/t3", seq: "/"},
			want:   true,
			want1:  "/t1/*",
		}, {
			name:   "t7",
			fields: fields{all: []string{"/t1/*", "/t1/*/*"}},
			args:   args{service: "/t1/t3/dd", seq: "/"},
			want:   true,
			want1:  "/t1/*/*",
		}, {
			name:   "t8",
			fields: fields{all: []string{"/t1/*", "/t1/t2/*"}},
			args:   args{service: "/t1/t2/dd", seq: "/"},
			want:   true,
			want1:  "/t1/t2/*",
		}, {
			name:   "t9",
			fields: fields{all: []string{"/t1/t2/ss", "/t1/t2/*"}},
			args:   args{service: "/t1/t2/dd", seq: "/"},
			want:   true,
			want1:  "/t1/t2/*",
		}, {
			name:   "t10",
			fields: fields{all: []string{"/t1/t2/ss", "/t1/t2/*"}},
			args:   args{service: "/t1/t2/ss", seq: "/"},
			want:   true,
			want1:  "/t1/t2/ss",
		}, {
			name:   "t11",
			fields: fields{all: []string{"/t1/t2/:name"}},
			args:   args{service: "/t1/t2/ss", seq: "/"},
			want:   false,
			want1:  "",
		}, {
			name:   "t12",
			fields: fields{all: []string{"/t1/t2/t3", "/t1/*/t4"}},
			args:   args{service: "/t1/t2/t4", seq: "/"},
			want:   true,
			want1:  "/t1/*/t4",
		}, {
			name:   "t13",
			...
			name:   "t15",
			fields: fields{all: []string{"/t1/**", "/t1/*/t4"}},
			args:   args{service: "/t1/t2/t4", seq: "/"},
			want:   true,
			want1:  "/t1/*/t4",
		}, {
			name:   "t16",
			fields: fields{all: []string{"192.168.5.124", "192.168.5.22"}},
			args:   args{service: "192.168.5.94", seq: "."},
			want:   false,
			want1:  "",
		}, {
			name:   "t17",
			fields: fields{all: []string{"192.168.5.124", "192.168.5.94"}},
			args:   args{service: "192.168.5.94", seq: "."},
			want:   true,
			want1:  "192.168.5.94",
		}, {
			name:   "t18",
			fields: fields{all: []string{"192.168.5.*"}},
			args:   args{service: "192.168.5.94", seq: "."},
			want:   true,
			want1:  "192.168.5.*",
		}, {
			name:   "t19",
			fields: fields{all: []string{"192.168.**"}},
			args:   args{service: "192.168.5.94", seq: "."},
			want:   true,
			want1:  "192.168.**",
		}, {
			name:   "t20",
			fields: fields{all: []string{"192.168.*.94"}},
			args:   args{service: "192.168.5.94", seq: "."},
			want:   true,
			want1:  "192.168.*.94",
		}, {
			name:   "t21",
			fields: fields{all: []string{"/t1/t2/t3", "/t1/t2/*", "/t1/*/t2", "/t1/**"}},
			args:   args{service: "/t1/t2/t3", seq: "/"},
			want:   true,
			want1:  "/t1/t2/t3",
		}, {
			name:   "t22",
			fields: fields{all: []string{"/t1/t2/*", "/t1/*/t2", "/t1/**"}},
			args:   args{service: "/t1/t2/t3", seq: "/"},
			want:   true,
			want1:  "/t1/t2/*",
		}, {
			name:   "t23",
			fields: fields{all: []string{"/t1/*/t3", "/t1/**"}},
			args:   args{service: "/t1/t2/t3", seq: "/"},
			want:   true,
			want1:  "/t1/*/t3",
		}, {
			name:   "t24",
			fields: fields{all: []string{"/**"}},
			args:   args{service: "/t1/t2/t3", seq: "/"},
			want:   true,
			want1:  "/**",
		}, {
