...
func TestMeta_GetBool(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "数据存在,值为rune-1", q: Meta{"yy": rune(1)}, args: args{name: "yy", def: []bool{}}, want: false},
		...
		{name: "数据存在,值为rune-t", q: Meta{"yy": rune('t')}, args: args{name: "yy", def: []bool{}}, want: false},
		...
		{name: "数据存在,值为rune-Y", q: Meta{"yy": rune('Y')}, args: args{name: "yy", def: []bool{}}, want: false},
