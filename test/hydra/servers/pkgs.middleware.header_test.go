...
func TestHeader(t *testing.T) {
	...
	tests := []*testCase{
		...
		{name: "3. header-设置-默认跨域头,无其他头", isSet: true, wantStatus: 200, wantSpecial: "hdr", headerOpts: []header.Option{header.WithCrossDomain()}, wantheader: map[string][]string{HeadeAllowCredentials: []string{"true"}, HeadeAllowMethods: []string{strings.Join(allMethods, ",")}, HeadeAllowOrigin: []string{"www.baidu.com"}, HeadeAllowHeaders: []string{strings.Join(allowHeader, ",")}, HeadeExposeHeaders: []string{strings.Join(exposeHeader, ",")}}},
		{name: "4. header-设置-默认跨域头,有其他头", isSet: true, wantStatus: 200, wantSpecial: "hdr", headerOpts: []header.Option{header.WithCrossDomain(), header.WithHeader("test1", "testttt")}, wantheader: map[string][]string{HeadeAllowCredentials: []string{"true"}, HeadeAllowMethods: []string{strings.Join(allMethods, ",")}, HeadeAllowOrigin: []string{"www.baidu.com"}, HeadeAllowHeaders: []string{strings.Join(allowHeader, ",")}, HeadeExposeHeaders: []string{strings.Join(exposeHeader, ",")}, "test1": []string{"testttt"}}},
		{name: "5. header-设置-指定跨域头,不允许跨域,无其他头", isSet: true, wantStatus: 200, wantSpecial: "hdr", headerOpts: []header.Option{header.WithCrossDomain("www.sdswds.com")}, wantheader: map[string][]string{HeadeExposeHeaders: []string{strings.Join(exposeHeader, ",")}}},
		{name: "6. header-设置-指定跨域头,不允许跨域,有其他头", isSet: true, wantStatus: 200, wantSpecial: "hdr", headerOpts: []header.Option{header.WithCrossDomain("www.sdswds.com"), header.WithHeader("test1", "testttt")}, wantheader: map[string][]string{HeadeExposeHeaders: []string{strings.Join(exposeHeader, ",")}, "test1": []string{"testttt"}}},
		{name: "7. header-设置-指定跨域头,允许跨域,无其他头", isSet: true, wantStatus: 200, wantSpecial: "hdr", headerOpts: []header.Option{header.WithCrossDomain("www.baidu.com")}, wantheader: map[string][]string{HeadeAllowCredentials: []string{"true"}, HeadeAllowMethods: []string{strings.Join(allMethods, ",")}, HeadeAllowOrigin: []string{"www.baidu.com"}, HeadeAllowHeaders: []string{strings.Join(allowHeader, ",")}, HeadeExposeHeaders: []string{strings.Join(exposeHeader, ",")}}},
		{name: "8. header-设置-指定跨域头,允许跨域,有其他头", isSet: true, wantStatus: 200, wantSpecial: "hdr", headerOpts: []header.Option{header.WithCrossDomain("www.baidu.com"), header.WithHeader("test1", "testttt")}, wantheader: map[string][]string{HeadeAllowCredentials: []string{"true"}, HeadeAllowMethods: []string{strings.Join(allMethods, ",")}, HeadeAllowOrigin: []string{"www.baidu.com"}, HeadeAllowHeaders: []string{strings.Join(allowHeader, ",")}, HeadeExposeHeaders: []string{strings.Join(exposeHeader, ",")}, "test1": []string{"testttt"}}},
	}
