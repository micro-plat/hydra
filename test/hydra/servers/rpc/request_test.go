...
func TestNewRequest(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "初始化入参是空对象", args: args{Service: "", Method: "", Header: "", Input: ""}, wantErr: "rpc请求头转换失败"},
		{name: "初始化入参是错误的header", args: args{Service: "service1", Method: "get", Header: "错误的header", Input: `{"taosy":"test"}`}, wantErr: "rpc请求头转换失败"},
		{name: "初始化入参是错误的input", args: args{Service: "service1", Method: "get", Header: `{"Host":"www.baidu.com"}`, Input: "错误的input"}, wantErr: "rpc请求参数转换失败"},
		{name: "初始化正确的参数对象", args: args{Service: "service1", Method: "get", Header: `{"Host":"www.baidu.com"}`, Input: `{"taosy":"test"}`}, wantErr: ""},
	}
