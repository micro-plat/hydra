...
func TestRASAuth(t *testing.T) {
	...
	tests := []*testCase{
		...
		{name: "rasAuth-启用-没有签名字段", isSet: true, wantStatus: 403, wantSpecial: "ras", queryMap: map[string]interface{}{"fied1": "111111"},
			opts: []ras.Option{ras.WithAuths(ras.New(reqUrl, ras.WithRequest("/rasauth/test"), ras.WithSignAlias("sign")))}},
		{name: "rasAuth-启用-错误的请求路径", isSet: true, wantStatus: 500, wantSpecial: "ras", queryMap: map[string]interface{}{"fied1": "111111"},
		...
		{name: "rasAuth-启用-错误的服务器地址", isSet: true, wantStatus: 500, wantSpecial: "ras", queryMap: map[string]interface{}{"fied1": "111111"},
			opts: []ras.Option{ras.WithAuths(ras.New("/single/hydra/newversion/md5/auth@authserver.sas_err",
				ras.WithRequest("/rasauth/test"), ras.WithSignAlias("sign")))}},
		{name: "rasAuth-启用-错误的签名字段", isSet: true, wantStatus: 403, wantSpecial: "ras", queryMap: map[string]interface{}{"fied1": "111111", "sign": "errordata", "euid": "test1"},
			opts: []ras.Option{ras.WithAuths(ras.New(reqUrl, ras.WithConnect(ras.WithConnectChar("=", "&"), ras.WithConnectSortByData(), ras.WithSecretConnect(ras.WithSecretHeadMode(""))),
				ras.WithRequest("/rasauth/test"), ras.WithSignAlias("sign")))}},
		{name: "rasAuth-启用-签名认证成功", isSet: true, wantStatus: 200, wantSpecial: "ras", queryMap: map[string]interface{}{"fied1": "111111", "euid": "test1", "sign": getRasSign(map[string]interface{}{"fied1": "111111", "euid": "test1"})},
			opts: []ras.Option{ras.WithAuths(ras.New(reqUrl, ras.WithConnect(ras.WithConnectChar("=", "&"), ras.WithConnectSortByData(), ras.WithSecretConnect(ras.WithSecretHeadMode(""))),
				ras.WithRequest("/rasauth/test"), ras.WithSignAlias("sign")))}},
		{name: "rasAuth-启用-空数据签名认证成功", isSet: true, wantStatus: 200, wantSpecial: "ras", queryMap: map[string]interface{}{"euid": "test1", "sign": getRasSign(map[string]interface{}{"euid": "test1"})},
			opts: []ras.Option{ras.WithAuths(ras.New(reqUrl, ras.WithConnect(ras.WithConnectChar("=", "&"), ras.WithConnectSortByData(), ras.WithSecretConnect(ras.WithSecretHeadMode(""))),
				ras.WithRequest("/rasauth/test"), ras.WithSignAlias("sign")))}},
	}
